...
export const EMERGENCY_RESOURCE_CONTACTS: EmergencyContactResource[] = [
  ...
  },
  {
    ...
    note: "Confirm the active local emergency number with your LGU or barangay.",
  ...
  },
  {
    ...
    phone: "143",
    coverage: "National",
    note: "Confirm the active medical emergency number with local responders in your area.",
    sourceType: "sample_demo",
    sourceName: "FloodWatch PH sample contact",
    isSample: true,
    callHref: "tel:143",
