...
- [ ] Make confirmation and resolution undo operations atomic so concurrent requests cannot corrupt denormalized counters.
- [ ] Stop trusting client-controlled proxy headers for rate-limit identity; use a deployment-provided client address or a trusted proxy boundary.
